...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonYes = findViewById(R.id.button2);
        buttonNo = findViewById(R.id.button3);
                    ...
                    public void onClick(View v) {
                        ...
                        if (!set1.isEmpty()) {
                            try {
                                ...
                                Toast.makeText(SecondActivity.this, "Please enter a valid number", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            // Show a message if the EditText is empty
                            Toast.makeText(SecondActivity.this, "Please enter a value", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
